...
var handleOnConnect = function() {
    ...
    updateStatusIcon('static/img/status_ok.png', 'Connected');
...
var handleOnDisconnect = function() {
    ...
    updateStatusIcon('static/img/status_error.png', 'Disconnected');
};
